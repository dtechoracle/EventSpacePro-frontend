...
const filePath = path.join(__dirname, '../public/assets/preloaded-venues/Eko hotel Convention Centre (Individual Halls).svg');
...
console.log('Done cleaning Eko Individual Halls SVG!');
