...
const EventCardShimmer = () => (
  <div className="relative w-full h-60 rounded-3xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-green-100/30 to-yellow-100/30">
      <div className="absolute -top-10 -left-10 w-40 h-40 bg-green-200/40 rounded-full blur-3xl opacity-70" />
