    ...
    <AuthLayout>
      <div className="w-full h-full flex items-center justify-center">
        ...
        <div className="w-full max-w-md bg-white p-8 flex flex-col items-center">
          ...
          <p className="text-black/75 font-medium text-sm mt-1">Create an account to get started with us</p>
          ...
          <button className="mt-6 w-full flex items-center justify-center gap-2 border rounded-lg py-2 hover:bg-gray-50">
            ...
            <span className="text-sm font-semibold text-black/70">Continue with google</span>
          </button>
          ...
          <span className="mt-6 text-sm text-gray-600 flex gap-1">
            ...
            <p className="text-[#4E1CD8] font-medium hover:underline cursor-pointer" onClick={() => router.push("/auth/login")}>
              Log In
            </p>
          </span>
        </div>
